...
# Endpoint for turning off relay number 2
endpoint = "http://10.40.1.21:80/turn_off/2"
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    light_state_collection.update_one(
                        {'relay_num': 2},  # Relay number 2
                        {'$set': {'state': False}},
                        upsert=True  # Create a new document if it doesn't exist
                    )
                    print("Relay state updated in MongoDB for relay 2")
