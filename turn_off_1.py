...
# Endpoint for turning off relay number 1
endpoint = "http://10.40.1.21:80/turn_off/1"
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    light_state_collection.update_one(
                        {'relay_num': 1},  # Relay number 1
                        {'$set': {'state': False}},
                        upsert=True  # Create a new document if it doesn't exist
                    )
                    print("Relay state updated in MongoDB for relay 1")
