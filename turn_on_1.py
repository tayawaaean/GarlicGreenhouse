...
# Endpoint for turning on relay number 1
endpoint = "http://10.40.1.21:80/turn_on/1"
        ...
        if schedule_document:
            ...
            try:
                ...
                if response.status_code == 200:
                    # Update the relay state in MongoDB for relay 1
                    light_state_collection.update_one(
                        {'relay_num': 1},  # Updated to relay_num 1
                        {'$set': {'state': True}},
